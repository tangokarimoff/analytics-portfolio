# 📦 Supply Chain Analytics — Spare Parts Localization Data Mart
...
- End users: coordination & procurement teams
...
The system is based on a **star schema** optimized for analytical queries.
...
- deriving delay and financial metrics across currencies

The result is a single analytical table used as the foundation for BI dashboards.

### Source File: `sql/orders_mart.sql`
<details>
<summary>View full SQL query (orders_mart.sql)</summary>
